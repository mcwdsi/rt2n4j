...
print(tuple_ntor)
print(retrieved_ntor)

print(tuple_ntor.rui)
print(tuple_ntor.ruin)
print(tuple_ntor.ruir)
print(tuple_ntor.r)
print(tuple_ntor.tr)
print(type(tuple_ntor.polarity))
print(retrieved_ntor.rui)
print(retrieved_ntor.ruin)
print(retrieved_ntor.ruir)
print(retrieved_ntor.r)
print(retrieved_ntor.tr)
print(type(retrieved_ntor.polarity))
